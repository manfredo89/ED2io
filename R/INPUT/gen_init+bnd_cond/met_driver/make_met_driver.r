...
outpath = "/Users/manfredo/Desktop/Rprova/gen_init+bnd_cond/met_driver/output"
#------------------------------------------------------------------------------------------#
...
for (p in sequence(nplaces)){
   ...
   for (um in sequence(n.unique.tomonth)){
      ...
      if (nsel == nexpected){
         ...
         dummy = h5save("dlwrf","nbdsf","nddsf","prate","pres"
                                  ,"sh","tmp","ugrd","vbdsf","vddsf","vgrd",file=thisfile)
         #---------------------------------------------------------------------------------#
      }else{
