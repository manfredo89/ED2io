...
set.idbh.type <<- function(idbh.type=3){
  #==========================================================================================#
  #==========================================================================================#
  ...
  if (idbh.type == 1){
    ...
    ndbh       <<-  14
    classdbh   <<- c(0,10,15,20,25,30,35,40,50,60,70,80,90,100)
    breakdbh   <<- c(-Inf,classdbh[-1],Inf)
    dbhlabel   <<- "tree_clss"
    dbhkeys    <<- paste(classdbh,"-",c(classdbh[-1],Inf),sep="")
    dbhnames   <<- paste( c("<",paste(classdbh[-c(1,ndbh)],"-",sep=""),">")
    ...
    stop(" Invalid IDBH.TYPE, it must be between 1 and 6 (feel free to add more options.")
  }#end if
}
#==========================================================================================#
#==========================================================================================#
